...
public class Advanced extends BaseImplementation {
	protected static final String THIS_FILE = "mxpress";
	...
	protected final static String FIELD_DISPLAY_NAME = "M Xpress";
    protected final static String FIELD_SERVER = "mxpress.zcomvoip.org";
    ...
    protected final static String FIELD_TCP = "5060";
	...
	public void fillLayout(final SipProfile account) {
		...
		if (serverFull == null) {
			...
			serverFull = serverFull.replaceFirst("sip:mxpress.zcomvoip.org:5060");
		}
